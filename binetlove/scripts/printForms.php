...
<div id="div_login">
   ...
   <div>
     <input  class="btn-rose btn-login my-2 my-sm-0" type="submit" value="Se connecter" name="but_submit" id="but_submit" />
   </div>
   <div>
     <a href='index.php?page=welcome&todo=register'><input class="btn-rose btn-login my-2 my-sm-0" type="submit" value="S'inscrire'" name="but_register" id="but_register" /></a>
   </div>
</div>
</form>
CHAINE_DE_FIN;
...
<a href='index.php?page=welcome&todo=logout'><input type="submit" value="Se déconnecter" class="btn-rose btn-login my-2 my-sm-0" name="but_logout" id="but_logout"/></a>
</div>
CHAINE_DE_FIN;
}
